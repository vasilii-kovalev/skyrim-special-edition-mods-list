...
* Put all the `*.esp` plugins right after `Landscape and Water Fixes.esp` one in the "Plugins" tab in the following order:
  * UHDAP - MusicHQ
  * UHDAP - en0
  * UHDAP - en1
  * UHDAP - en2
...
* Download, install and enable ["Audio Overhaul Skyrim (4.0.1)" file](https://www.nexusmods.com/skyrimspecialedition/mods/12466?tab=files&file_id=332351&nmm=1). Choose the following options in FOMOD:
  * "Audio Overhaul for Skyrim (4.0.0)" page:
    ...
    * "Consistency Plugins" section:
      * Uncheck everything
* Disable `AOS_EBT Patch.esp` plugin in the "Plugins" tab for now
...
* Enable `AOS_EBT Patch.esp` file in the "Plugins" tab and put right after `AOS_ISC_Integration.esp` one
...
* ["ISC Enhanced Blood Textures Patch" file](https://www.nexusmods.com/skyrimspecialedition/mods/2951?tab=files&file_id=4512&nmm=1) is not used because [lilebonymace's patches and xEdit scripts]() already has it, it's newer, and also covers [Audio Overhaul for Skyrim SE]()
...
* Grass generation will be performed at the very end
...
* Download, install and enable ["ISC-SRDified Main File" file](https://www.nexusmods.com/skyrimspecialedition/mods/78446?tab=files&file_id=333619&nmm=1)
...
* Download, install and enable ["kryptopyr's Patch Hub Installer" file](https://www.nexusmods.com/skyrimspecialedition/mods/19518?tab=files&file_id=300905&nmm=1). Choose the following options in FOMOD:
  ...
  * "Which versions of these mods do you have installed?" page:
    * "Gemling Queen Jewelry" section:
      * Uncheck everything
    * "Guards Armor Replacer" section:
      * Select "None" option
    * "Hunterborn" section:
      * Select "None" option
    * "JS Circlet Replacer" section:
      * Uncheck everything
    * "Medieval Spirits" section:
      * Uncheck everything
    * "Truly Light Elven Armor (Male)" section:
      * Uncheck everything
    * "Warmonger Armory" section:
      * Select "None" option
  ...
  * "Weapons Armor Clothing and Clutter Fixes - Combination Patches" page:
    * "Bonemold Weapon Pack" section:
      * Select "None" option
    * "Bonemold Weapon Pack and Thaumaturgy" section:
      * Select "None" option
    * "Cloaks of Skyrim" section:
      * Select "None" option
    * "Custom Craftable Pickaxes" section:
      * Select "None" option
    * "Custom Craftable Wood Axes" section:
      * Select "None" option
    * "Dawnguard Arsenal" section:
      * Select "None" option
    * "Fearsome Fists - Creation Club" section:
      * Select "None" option
    * "Fishing - Creation Club" section:
      * Select "None" option
    * "Guards Armor Replacer" section:
      * Select "None" option
    * "Immersive Armors" section:
      * Select "None" option
    * "Immersive Weapons" section:
      * Select "None" option
    * "Improved Closefaced Helmets" section:
      * Select "None" option
    * "Katana Crafting" section:
      * Select "None" option
    * "New Legion" section:
      * Select "None" option
    * "Open Faced Guard Helmets" section:
      * Select "None" option
    * "Ordinator" section:
      * Select "None" option
    * "Scout Armor" section:
      * Select "None" option
    * "Skyrim Immersive Creatures" section:
      * Select "None" option
    * "SPOA Silver Knight Armor" section:
      * Select "None" option
    * "SPOA Silver Knight Shield" section:
      * Select "None" option
    * "SPOA Silver Knight Shield" section:
      * Select "None" option
    * "Thaumaturgy" section:
      * Select "WACCF and ACE" option
    * "Unique Uniques" section:
      * Select "None" option
    * "Warmonger Armory" section:
      * Select "None" option
...
* Download, install and enable ["lilebonymace patches" file](https://www.nexusmods.com/skyrimspecialedition/mods/36042?tab=files&file_id=331457&nmm=1). Choose the following options in FOMOD:
  ...
  * "[6/6] Mod Fixes and Tweaks" page:
    ...
    * "Tweaks" section:
      * Uncheck everything
    * "Remove Those Config Spells" section:
      * Uncheck everything
...
* "Patch for Interesting NPCs 3.4.2 + USSEP 4.1.7" was not chosen because [Interesting NPCs SE (3DNPC)]() already has all the changes. The patch even breaks some things
