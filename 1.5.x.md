...
* Make the following changes in the `SKSE/Plugins/ScrambledBugs.json` file of the [Scrambled Bugs]() mode:
...
* [Address Library for SKSE Plugins]() (for "Weapon Enchantment XP Tweak" file)
...
* [Weapons Armor Clothing and Clutter Fixes]()
* [RUSTIC CLOTHING - Special Edition]() (in order to maintain consistency with the added textures and normal maps)
...
* "WACCF - USSEP Arch-Mage Consistency Patch" patch on the "Weapons Armor Clothing and Clutter Fixes Patches" page was not chosen because the mod itself allows to skip it, if [Armor and Clothing Extension]() is used. "WACCF and ACE - USSEP Arch-Mage Consistency Patch" option, checked on the "Armor and Clothing Extension Patches" page, is used instead
* "Cutting Room Floor" patch on the "Weapons Armor Clothing and Clutter Fixes Patches" page was not chosen because [kryptopyr's Patch Hub]() mod already provides it
